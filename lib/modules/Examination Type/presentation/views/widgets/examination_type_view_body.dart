...
class ExaminationTypeViewBody extends StatefulWidget {
  ...
  @override
  State<ExaminationTypeViewBody> createState() => _ExaminationTypeViewBodyState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ExaminationTypeCubit, ExaminationTypeState>(
      builder: (context, state) => Column(
        children: [_buildSearchField(cubit), const HeightSpacer(size: 10), const ExaminationTypeListView()],
      ),
    );
  }

  Widget _buildSearchField(ExaminationTypeCubit cubit) {
    return Container(
      color: Colorz.white,
      child: Padding(
