...
class DashboardStatsCards extends StatelessWidget {
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                  "Monitor appointments, branch activity, and patient flow at a glance.",
                  style: TextStyle(
        ...
        LayoutBuilder(builder: (context, constraints) {
          ...
          if (useScroll) {
            return SingleChildScrollView(
              ...
              clipBehavior: Clip.none, // Allow cards to show outside bounds if needed
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24.0),
                child: Row(
                  children: [
                    SizedBox(
                        ...
                        child: _buildCard(
                            context,
                            "TODAY",
                            operational?.today?.total?.toString() ?? "0",
                            "Appointments",
                            Colors.green,
                            isDark)),
                    ...
                    SizedBox(
                        ...
                        child: _buildCard(
                            context,
                            "TOMORROW",
                            operational?.tomorrow?.total?.toString() ?? "0",
                            "Scheduled",
                            Colors.blue,
                            isDark)),
                    const SizedBox(width: 12),
                    SizedBox(
                        ...
                        child: _buildCard(
                            context,
                            "PENDING",
                            operational?.pendingFinalizations?.toString() ??
                                "0",
                            "Finalizations",
                            Colors.deepOrange,
                            isDark)),
              ...
              children: [
                ...
                Expanded(
                    child: _buildCard(
                        context,
                        "PENDING",
                        operational?.pendingFinalizations?.toString() ?? "0",
                        "Finalizations",
                        Colors.deepOrange,
                        isDark)),
              ],
  ...
  Widget _buildCard(BuildContext context, String title, String value, String subtitle, MaterialColor color, bool isDark) {
    final bgColor = isDark ? color.withValues(alpha:  0.15) : color.shade50;
      ...
      child: Column(
        ...
        children: [
          ...
          FittedBox(
            fit: BoxFit.scaleDown,
            alignment: Alignment.centerLeft,
            child: Text(subtitle, style: TextStyle(color: color.withValues(alpha: 0.8), fontSize: 14))
          ),
        ],
      ),
    );
