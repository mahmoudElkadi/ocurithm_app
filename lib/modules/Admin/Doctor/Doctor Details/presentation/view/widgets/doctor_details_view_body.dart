...
import '../../../../../Doctor/Add Doctor/presentation/view/widgets/add_Doctor_view_body.dart';
...
class EditDoctorViewBody extends StatefulWidget {
  const EditDoctorViewBody({super.key});
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const HeightSpacer(size: 20),
                    TextField2(
                      // borderMain: DoctorDetailsCubit.get(context).textField == true ? Colorz.blue : null,
                      ...
                      children: [
                        Expanded(
                          ...
                          child: TextField2(
                            ...
                            borderColor: Colorz.activeIcon,
                            radius: 30,
                            isPassword: DoctorDetailsCubit.get(context).obscureText,
                            suffixIcon: DoctorDetailsCubit.get(context).obscureText == false
                                ? IconButton(
                                    onPressed: () {
                                      DoctorDetailsCubit.get(context).obscureText = !DoctorDetailsCubit.get(context).obscureText;
                                    },
                        ...
                        if (cubit.readOnly == false) {
                          showDatePicker(
                            ...
                            if (selectedDate != null) {
                              DoctorDetailsCubit.get(context).date = DateTime(
                                selectedDate.year,
                                selectedDate.month,
                                selectedDate.day,
                              );
                              setState(() {
                                log(DoctorDetailsCubit.get(context).date.toString());
                              });
                            }
                          });
                        }
                      ...
                      child: Ink(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(30),
                            border:
                                Border.all(color: DoctorDetailsCubit.get(context).picDate == false ? Colors.redAccent : Colors.transparent, width: 1),
                          ),
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Center(
                                  child: Text(
                                    DoctorDetailsCubit.get(context).date != null ? "${DoctorDetailsCubit.get(context).date!.day}" : S.of(context).dd,
                              ...
                              Expanded(
                                child: Center(
                                  child: Text(
                                    DoctorDetailsCubit.get(context).date != null
                                        ? "${DoctorDetailsCubit.get(context).date!.month}"
                                        : S.of(context).mm,
                                    style: appStyle(context, 18, Colorz.black, FontWeight.w600),
                                  ),
                                ),
                              ...
                              Expanded(
                                child: Center(
                                  child: Text(
                                    DoctorDetailsCubit.get(context).date != null ? "${DoctorDetailsCubit.get(context).date!.year}" : S.of(context).yy,
                                    style: appStyle(context, 18, Colorz.black, FontWeight.w600),
                                  ),
                                ),
                              ),
                    ...
                    if (DoctorDetailsCubit.get(context).picDate == false)
                      Padding(
                    ...
                    //     onTap: () {
                    //       log("message");
                    //       DoctorDetailsCubit.get(context).validateFirstPage();
                    //       log("message1");
                    //       log(DoctorDetailsCubit.get(context).isValidate.toString());
                    //
                    //       setState(() {});
                    //       if (formKey.currentState!.validate() && DoctorDetailsCubit.get(context).isValidate) {
                    //         customLoading(context, "");
                    //         DoctorDetailsCubit.get(context).DoctorDetails(
                    //           context: context,
                    //           fullName: nameController.text,
                    //           password: passwordController.text,
                    //           phone: phoneNumberController.text,
                    //           gender: DoctorDetailsCubit.get(context).selectedGender!,
                    //           dateOfBirth: DoctorDetailsCubit.get(context).date.toString(),
                    //           branchId: DoctorDetailsCubit.get(context).branchId.toString(),
                    //         );
                    //       }
                    //     },
