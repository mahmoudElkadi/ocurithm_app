...
class CreateDoctorCubit extends Cubit<CreateDoctorState> {
  ...
  //   var response = await createDoctorRepo.createDoctor(
  //     fullName: fullName,
  //     password: password,
  //     phone: phone,
  //     gender: gender,
  ...
  //     if (result == true) {
  //       await (branchModel = createDoctorRepo.getBranch());
  //     }
