...
class ReceptionistDetailsCubit extends Cubit<ReceptionistDetailsState> {
  ReceptionistDetailsCubit(this.receptionistDetailsRepo) : super(ReceptionistDetailsInitial());

  static ReceptionistDetailsCubit get(context) => BlocProvider.of(context);
  ReceptionistDetailsRepo receptionistDetailsRepo;
  ...
  //     if (result == true) {
  //       await (branchModel = ReceptionistDetailsRepo.getBranch());
  //     }
