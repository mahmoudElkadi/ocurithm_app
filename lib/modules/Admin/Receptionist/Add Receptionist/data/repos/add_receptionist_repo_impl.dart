...
import '../models/create_patient_model.dart';
import 'add_receptionist_repo.dart';

class CreateReceptionistRepoImpl implements CreateReceptionistRepo {
  @override
  Future<CreateReceptionistModel> createReceptionist({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return CreateReceptionistModel.fromJson(response.data);
      } else {
        return CreateReceptionistModel.fromJson(response.data);
      }
    } catch (e) {
      ...
      return CreateReceptionistModel.fromJson({});
    }
  }
