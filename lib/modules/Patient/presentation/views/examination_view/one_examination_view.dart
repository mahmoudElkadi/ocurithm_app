...
import 'package:ocurithm/modules/Examination/presentaion/views/widgets/circle_view.dart';
...
class _OneExaminationViewState extends State<OneExaminationView>
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            _buildPatientInfoCard(state.examination!),
                            _buildFinalizationSection(state.examination!),
                            _buildHistorySection(state.examination!),
                          ],
                        ),
  ...
  Widget _buildMedicationContent(Action action, List<Medicine>? medicines,
  ...
  Widget _buildGlassesContent(
      Action action, ExaminationModel examinationModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildDetailItem(
  ...
  Widget _buildLaserContent(Action action, ExaminationModel examinationModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildDetailItem(
  ...
  Widget _buildORContent(Action action, ExaminationModel examinationModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildDetailItem(
  ...
  Widget _buildEyeExaminationContent(
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          ...
          _buildQuadrantSection(isLeft: isLeft, examinationModel: examination),
  ...
  Widget _buildPatientInfoCard(ExaminationModel examination) {
    return Card(
      elevation: 4,
      shadowColor: Colorz.primaryColor.withOpacity(0.2),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
  ...
  Widget _buildFinalizationSection(ExaminationModel examination) {
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            ...finalization.actions.map((action) => Column(
                  children: [
                    _buildActionContent(
                        action, finalization.medicine, examination),
                    const HeightSpacer(size: 10),
                    Divider(
                      color: Colors.black,
                    ),
  ...
  Widget _buildActionContent(
      Action action, List<Medicine>? medicines, ExaminationModel examination) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildActionSpecificContent(action, medicines, examination),
        if (action.eye != null) ...[
          const SizedBox(width: 8),
          Padding(
  ...
  Widget _buildActionSpecificContent(
    ...
    switch (action.action?.toLowerCase()) {
      case 'prescribe glasses':
        return _buildGlassesContent(action, examination);
      case 'prescribe medications':
        return _buildMedicationContent(action, medicines, examination);
      case 'refer to investigations':
        return _buildInvestigationsContent(action, examination);
      case 'refer to lasers':
        return _buildLaserContent(action, examination);
      case 'keratoconus':
        return _buildKeratoconusContent(action, examination);
      case 'refer to or':
        return _buildORContent(action, examination);
      case 'book next appointment':
        return _buildAppointmentContent(action, examination);
      default:
        return const SizedBox.shrink();
    }
  }
  ...
  Widget _buildHistorySection(ExaminationModel examinationModel) {
