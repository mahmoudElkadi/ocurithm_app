...
// // Please use the new cubit structure:
// // - BranchActionsCubit for add/update/delete operations
// // - GetBranchesCubit for fetching branches
// // - GetSingleBranchCubit for fetching single branch
// //
// // See: lib/modules/branch/REFACTORING_SUMMARY.md for migration guide
//
...
//
// @Deprecated(
//     'Use BranchActionsCubit, GetBranchesCubit, and GetSingleBranchCubit instead')
...
//   updateBranch(
//       {required String id,
//       required AddBranchModel addBranchModel,
//       context}) async {
//     emit(AdminBranchLoading());
//     try {
...
//
//         final index =
//             branches?.branches?.indexWhere((branch) => branch.id == id);
//         if (index != -1) {
...
//         emit(AdminBranchError());
//       } else {
//         clinics = await ServicesApi()
//             .getAllClinics(page: page, search: searchController.text);
//
